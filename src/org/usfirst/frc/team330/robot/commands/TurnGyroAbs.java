...
public class  TurnGyroAbs extends Command implements AutoSpreadsheetCommand {
    ...
    protected void initialize() {
        Robot.drivetrain.leftDrivePID.disable();
        Robot.drivetrain.rightDrivePID.disable();  
        //TODO preferences
 //       Robot.drivetrain.gyroPID.setGainName(Robot.drivetrain.TURN);

        Robot.drivetrain.gyroPID.setAbsoluteTolerance(tolerance);
        Robot.drivetrain.gyroPID.setSetpoint(angle);
//        System.out.println("TurnGyroAbs Enable: " + enable);
//        System.out.println("TurnGyroAbs Name: " + Robot.drivetrain.gyroPID.getGainName());
//        System.out.println("TurnGyroAbs P: " + Robot.drivetrain.gyroPID.getP());
        if (enable) 
    ...
    protected boolean isFinished() {
        if (Robot.drivetrain.gyroPID.onTarget() || isTimedOut())
        {
            return true;
        }
        return false;
