...
public class  DriveDistance extends Command implements AutoSpreadsheetCommand {
    ...
    protected void initialize() {
        ...
        Robot.drivetrain.leftDrivePID.setSetpoint(leftDistance);
        Robot.drivetrain.rightDrivePID.setSetpoint(rightDistance);
        Robot.drivetrain.leftDrivePID.enable();
        Robot.drivetrain.rightDrivePID.enable();
        Robot.drivetrain.leftDrivePID.setAbsoluteTolerance(tolerance);
        Robot.drivetrain.rightDrivePID.setAbsoluteTolerance(tolerance);
    ...
    protected boolean isFinished() {
        if (Robot.drivetrain.leftDrivePID.onTarget() || Robot.drivetrain.rightDrivePID.onTarget() || isTimedOut())
        {
                return true;            
        }
        return false;
    ...
    protected void end() {
        if (stopAtEnd)
        {
            ...
            System.out.println("stopping drive after DriveDistance");
        }
    }
